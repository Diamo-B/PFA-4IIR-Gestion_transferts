...
import { resetSelection, setType } from '../../../Redux/locations';
const Card = () => {
    ...
    return (
        <div className="flex justify-center items-center gap-5 w-full">
            <button
                ...
                onClick={()=>{dispatcher(setType("Location"))&&dispatcher(resetSelection())}} 
            >
            ...
            <button
                ...
                onClick={()=>{dispatcher(setType("Transfers"))&&dispatcher(resetSelection())}}
            >
                <div className="flex flex-col justify-center items-center">
                    <div>
